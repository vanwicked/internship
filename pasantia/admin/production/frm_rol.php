            ...
            <div class="">
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            <div class="x_title">
                                <h2>Formulario de Roles Nuevos</h2>
                            ...
                            <div class="x_content">
                                ...
                                <form action="../../enrutador/enr_rol.php" method="post" class="form-horizontal form-label-left"  novalidate>
                                    <div class="item form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="nombre">Rol: <span class="required">*</span>
                                        </label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input id="name" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" data-validate-words="1" name="nombre" placeholder="Registre un nuevo rol..." required="required" type="text">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-6 col-md-offset-3">
                                            ...
                                            <input  class="btn btn-danger" type="submit" name="agregar" value="Registrarse"/>
                                        </div>
                                    </div>
                                </form>
                            </div>
