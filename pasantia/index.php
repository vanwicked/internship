...
<head>
	...
	<title>Proyecto control de pasantias</title>
</head>
<body background="images/47.jpg" style="background-attachment: fixed" >
<center><h1>INTERSHIP</h1></center>
	...
	<table border="0" align="center" valign="middle">
		...
		<tr><td></td>
			<td width=70 ><input class="btn btn-primary" type="submit" value="Aceptar"></td>
